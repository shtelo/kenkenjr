...
APPLICATION_TIMESTAMP = 0   # A
APPLICATION_EMAIL = 1       # B
APPLICATION_DISCORD_ID = 2  # C
APPLICATION_SUBACCOUNT = 3  # D
APPLICATION_NICKNAME = 4    # E
APPLICATION_INVITER = 5     # F
APPLICATION_KNOWLEDGE = 6   # G
APPLICATION_TWITTER_ID = 7  # H
APPLICATION_STATE = 17      # R
